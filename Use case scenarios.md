...
| Normal flow | Download an attendance file  + Teachers login  + Teachers choose course name from the course list drop down + System shows a list of files sorted by category + Teachers choose date+ System will show the file according to the chosen date + Teachers download the file |
| --- | --- |
